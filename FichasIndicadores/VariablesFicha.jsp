...
<form name="buscar" method="post" action='<c:url value="/BancoVariables/llenarFiltro.jsp"/>'>
	...
	<caption>Filtro de Búsqueda de Variables y/o Resultados de Indicadores</caption>
		<tr>
...
<form name="form2" method="post" action='<c:url value="/FichasIndicadores/llenarFicha.jsp"/>'>
<table class="tablas" width="95%" align="center">
	<tr></tr>
	<tr></tr>
	<tr><td colspan="8" class="renglones" align="center"><b>SEGUNDO PASO: SELECCIONE LAS VARIABLES</b></td></tr>
	<tr></tr>
	<tr></tr>
		...
		<c:forEach items="${sessionScope.listaFiltro}" begin="0" var="lista" varStatus="st">
		<tr <c:if test="${st.count mod 2==0}">class="trb"</c:if>>
			...
			<td align="center"><input type="checkbox" name="variables"  value=<c:out value="${lista.identificador}" />></td>
		</tr>
		</c:forEach>
		<tr>
			<td colspan="8" align="center"><img src='<c:url value="/comp/img/Siguiente.gif"/>' onclick="guardar1()"></td>
		</tr>
