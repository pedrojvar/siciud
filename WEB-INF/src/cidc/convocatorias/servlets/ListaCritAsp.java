...
public class ListaCritAsp extends ServletGeneral {
	...
	public String [] operaciones(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException {
		...
		String irA="/Convocatoria/ListaCritAsp.jsp";
		int ver=0;
		if(req.getParameter("ver")!=null)
			ver=Integer.parseInt(req.getParameter("ver"));
		
		sesion.setAttribute("listaCritOBJ",convocatoriasDB.listaCriterios(0));
		sesion.setAttribute("listaAspOBJ",convocatoriasDB.listaAspectos(0));
