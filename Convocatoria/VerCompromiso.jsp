...
<form name="requisito" action='<c:url value="/convocatoria/crear.x"/>'>
	...
	<input type="hidden" name="comId" value='<c:out value="${requestScope.convocatoriaOBJ.comId}"/>'>
	<br><br>

	<table class="tablas" align="center">
	<caption>Datos Compromiso</caption>
		<tr>
			<td class="renglones"><b>Nombre</b></td>
			<td><input type="text" name="comNombre" value='<c:out value="${requestScope.convocatoriaOBJ.comNombre}"/>'></td>
