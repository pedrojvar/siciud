...
<br>
	...
	<legend>Justificación de la participación y Agenda de Cooperación planteada por el investigador</legend>
		<table>
			<tr>
				<td colspan="3" class="renglones"><b>Justificación de la participación y Agenda de Cooperación (30 puntos)</b></td>
			</tr>
			<tr>
				<td colspan="3">
				<table width="100%">
					<tr>
						<td valign="top"><b>1) Justificación de la participación en el evento (10 puntos)</b></td>
					</tr>
					<tr>
						<td>
...
<!--		<tr>
	...
	<input type="hidden" name="accion" value="3">
		<table class="tablas" align="center">
			...
			<c:if test="${sessionScope.InfoA.papel==1 or sessionScope.InfoA.papel==2}">
			<tr>
				<td>Justificación de la participación en el evento en cuanto a la importancia del mismo en el cumplimiento de los objetivos personales.</td>				
