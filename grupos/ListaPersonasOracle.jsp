...
<body>
	<br>
	<form name="filtroConsulta" action='<c:url value="/grupos/GestionGrupo.x"/>' method="post">
...
<form name="lista" action='<c:url value="/grupos/GestionGrupo.x"/>' method="post">
	<input type="hidden" name="accion" value='8' >
	<input type="hidden" name="cedula" value="">
	<input type="hidden" name="codUD" value="">
	<input type="hidden" name="flagMod" value='1'>
		<br>
		<br>
