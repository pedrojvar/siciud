...
<input type="hidden" name="convId2" value="<c:out value="${lista.conv}"/>">
		...
		<td class="estado" align="center">
			<input type="text" name="observaciones1" size="20" '<c:forEach begin="0" items="${sessionScope.listaCalOBJ}" var="lista6" varStatus="st">' '<c:if test="${lista6.codPropuesta==lista.codPropuesta}">' value="${lista6.total1}" '</c:if>' '</c:forEach>' value="0">
		</td>
		<td class="estado" align="center">
			<input type="text" name="observaciones2" size="20" '<c:forEach begin="0" items="${sessionScope.listaCalOBJ}" var="lista6" varStatus="st">' '<c:if test="${lista6.codPropuesta==lista.codPropuesta}">' value="${lista6.total2}" '</c:if>' '</c:forEach>' value="0">
		</td>
		<td class="estado" align="center">
		...
		<c:if test="${tipo==2}">
			<c:forEach begin="0" items="${sessionScope.listaEvalOBJ}" var="lista5" varStatus="st">
			<td>
			<input type="text" name="valorCal" size="2" '<c:forEach begin="0" items="${sessionScope.listaCalOBJ}" var="lista6" varStatus="st">' '<c:if test="${lista6.evaluador==lista5.codigo}">'  value="${lista6.total1}" '</c:if>' '</c:forEach>' value="0">
			</td>
<input type="hidden" name="codProp" value="<c:out value="${lista.codPropuesta}"/>">
<input type="hidden" name="convId" value="<c:out value="${lista.conv}"/>">
<input type="hidden" name="codCrit" value="<c:out value="${lista3.codigo}"/>">
