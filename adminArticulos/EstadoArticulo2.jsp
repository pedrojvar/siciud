	...
	<table class="tablas" align="center">
		...
		<tr>
			<td>
				...
				<c:if test="${!empty sessionScope.datosArticulo.listaEvaluador}">
				<c:forEach begin="0" items="${sessionScope.datosArticulo.listaEvaluador}" var="lista" varStatus="st">
					<tr>
						<td><c:out value="${lista.nombre}"/></td>
						<td align="center"><c:out value="${lista.asigancion}" /></td>
						<td align="center">
