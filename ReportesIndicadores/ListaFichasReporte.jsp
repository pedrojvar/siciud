...
<form name="form1" method="post" action='<c:url value="/FichasIndicadores/llenarFicha.jsp"/>'>
<table class="tablas" width="95%" align="center">
		...
		<tr>
			...
			<td class="renglones" align="center" style="width: 5%"><b>Reporte</b></td>
		</tr>
		...
		<tr <c:if test="${st.count mod 2==0}">class="trb"</c:if>>
			...
			<td align="center"><a href='<c:url value='/reportesIndicadores/AdminReportes.x?accion=2&idind=${lista.id}&grafica=${lista.identificador}'/>'><img border="0" src='<c:url value="/comp/img/chart.png"/>'></a></td>
		</tr>
		</c:forEach>
	</table>
</form>
