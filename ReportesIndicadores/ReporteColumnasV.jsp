...
<form name="form1" method="post" action='<c:url value="/ReportesIndicadores/llenar.jsp"/>'>
<table class="tablas" width="95%" align="center">
	...
	<tr>
	    ...
	    <td class="lroja3" align="center"><a class="menu" href="/siciud/ReportesIndicadores/ReporteColumnasH.jsp?nombre=<c:out value="${sessionScope.nombreGrafica}"/>">Ver en Columnas Horizontales</a></td>
	</tr>
	<tr>
	<td colspan="2" >
		<div id="flashcontent" align="center">
			...
			<script type="text/javascript">
				...
				so.addVariable("settings_file", encodeURIComponent("/siciud/ReportesIndicadores/GraficosColumnas/Configuracion2.xml"));
