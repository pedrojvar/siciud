...
<table class="tablas" width="95%" align="center">
	...
	<td colspan="2" >
		<div id="flashcontent" align="center">
			<script type="text/javascript" src="/siciud/ReportesIndicadores/GraficosTortas/swfobject.js"></script>
			<script type="text/javascript">
				var so = new SWFObject("/siciud/ReportesIndicadores/GraficosTortas/Tortas.swf", "ampie", "500", "350", "8", "#FFFFFF");
				so.addVariable("path", "/siciud/ReportesIndicadores/GraficosTortas");
				so.addVariable("settings_file", encodeURIComponent("/siciud/ReportesIndicadores/GraficosTortas/Configuracion1.xml"));
				so.addVariable("data_file", encodeURIComponent("/siciud/ReportesIndicadores/GraficosTortas/Datos/<c:out value="${sessionScope.nombreGrafica}"/>"));
