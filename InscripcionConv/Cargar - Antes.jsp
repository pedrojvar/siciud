...
<script>
	...
	function terminar(){
		if(&& (document.frm3.fichero!=null ||document.frm3.fichero!="") && (document.frm4.fichero!=null ||document.frm4.fichero!="") && (document.frm5.fichero!=null||document.frm5.fichero!="")){
			...
			<table>
				...
				<tr>
					...
					<form action='<c:url value="/inscripcionConv/Inscripcion.x" />' method="post" name="finaliza">
						...
						<input type="hidden" name="idProp" value='<c:out value="${requestScope.archivos.idPropuesta}" default="${sessionScope.inscripcionConvOBJ.propId}"/>'>
						<img src='<c:url value="/comp/img/Terminar.gif" />' onclick="terminar()">					
					</form>
					</td>
				</tr>
			</table>
